...
环境：公网服务器（ip: 10.172.0.101） 内网服务器（ip: 192.168.0.101）
...
```
$ anchor link -L 192.168.0.101:9091 -R :1234
```

##### 3.1.8.3 公网客户端

在公网访问10.172.0.101:9090，等同于访问内网192.168.0.105:1234

```
$ telnet 10.172.0.101 9090
```
